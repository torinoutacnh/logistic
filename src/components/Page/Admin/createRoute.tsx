...
export function CreateRoute(props?: {
  ...
  ///////////////////////////////////////////////////////////////////////////
  const defaultValues: RouteModel = {
    fromId: "",
    toId: "",
    distanceByKm: 0,
    day: 0,
                      ...
                      <div className={styles.item}>
                              ...
                              return (
                                <>
                                  <option value={item.id} key={index}>
                                    {item.houseNumber} {item.street} {item.ward}{" "}
                        ...
                        <div className={styles.box_input}>
                          ...
                          <input
                            required={true}
                            className={styles.input}
                            {...register(`listRoute.${index}.distanceByKm`, {
                              value: Number(),
                            })}
                            type="number"
                          />
                        ...
                        <div className={styles.box_input}>
                          ...
                          <input
                            required={true}
                            className={styles.input}
                            {...register(`listRoute.${index}.minute`, {
                              value: Number(),
                            })}
                            type="number"
                          />
